...
| HU07 | Como **administrador**, Eu quero **monitorar as avaliações** e resenhas feitas pelos estudantes, Para garantir que o conteúdo compartilhado esteja **dentro das diretrizes** da plataforma e que não haja conteúdo impróprio. | 1. O administrador pode visualizar todas as avaliações feitas pelos estudantes.<br>2. O administrador pode filtrar as avaliações por livro, data ou nota.<br>3. O administrador tem a opção de excluir ou editar avaliações que violem as regras de uso (ex: conteúdo impróprio). | Alta | [RF13](RF.md#RF13), [RNF08](RNF.md#RNF08) | 5 |
