...
Os requisitos de usuário foram levantados por meio de um formulário aplicado a estudantes do IFPR, Campus Jacarezinho.  As seguintes funcionalidades são consideradas importantes pelo público-alvo:
...
* **Disponibilidade na Biblioteca:** A verificação da disponibilidade do livro na biblioteca do IFPR é uma funcionalidade com alto índice de aprovação.
