...
# Inspeção dos Requisitos do Projeto Codex/Biblio - Realizado pelo time ScrumMasters
...
* [Link: Clique aqui para visualizar o documento](Requisitos de Usuário/Inspeção dos Requisitos_Defeitos Encontrados (CODEX).pdf)
